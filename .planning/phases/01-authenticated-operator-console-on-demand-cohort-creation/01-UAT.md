...
updated: 2026-07-08T21:51:43Z
---

## Current Test

number: 1
name: Login screen + anonymous surface visual fidelity (plan 01-01)
expected: |
  Visual fidelity to 01-UI-SPEC.md: dark-slate 60/30/10, accent color reserved to the
  Sign in CTA / active nav / wordmark. Wrong password shows the exact invalid-password
  copy; correct password reveals the console shell with a Sign out button; `/` (root)
  shows the anonymous participant surface.
