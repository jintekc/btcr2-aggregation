...
- [ ] **SVC-01**: Operator can create and configure a new cohort on demand, choosing beacon type (CAS or SMT), Bitcoin network, n-of-n threshold, and capacity/roster, without editing boot-time env vars or restarting the process
